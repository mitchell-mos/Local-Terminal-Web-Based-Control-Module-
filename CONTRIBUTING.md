...
5. Run `pnpm test`, `pnpm run build`, and `pnpm audit` before opening a pull request.
6. Explain any new subprocess, filesystem, clipboard, network, or environment access in the pull request and README.
