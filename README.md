...
```sh
shasum -a 256 -c Control-Module-v1.03.2-macOS-arm64.zip.sha256
gh attestation verify Control-Module-v1.03.2-macOS-arm64.zip --repo mitchell-mos/Local-Terminal-Web-Based-Control-Module-
```
